...
public class ExamResource extends ServerResource {
	public ExamResource() {
	 ...
	 * <ul>
	 * <li>To generate reports for all the classes</li>
	 * <li>Change the details of the examination in the data-store and
	 * spreadsheets</li>
	 * </ul>
	 */
	@Override
	...
	/**
	 * Called by the user to create an examination <br/>
	 * This in turn adds process to the exam processing queue to create each
	 * worksheet per class
	 */
	@Override
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			...
			// Refer below for the 12 fields
			worksheetEntry.setColCount(12);
			...
			String headers[] = new String[] { "Standard", "Section", "Subject",
					"Staff Id", "Minimum", "Maximum", "Highest", "Average",
